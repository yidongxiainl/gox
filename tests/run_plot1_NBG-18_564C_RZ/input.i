...
#     diffusivity_scaling_factor = 2.19697
#     reactive_surface_area = 2.5e3
#     rate_scaling_factor = 0.004   # 0.00475 (bad)
#     power_exponent = 1.0

     ### input parameters for NBG-18 at 744 degree Celsus

#     initial_porosity = 0.1782
#     initial_bulk_density = 1851
#     diffusivity_scaling_factor = 2.19697
#     reactive_surface_area = 2.5e3
#     rate_scaling_factor = 0.004
#     power_exponent = 1.0
