...
[Mesh]
  ...
  nx = 50
  ny = 100
  xmax = 0.00425 # test chamber radius
  ymax = 0.01905 # 1/2 length of test chamber
[]
################################################################################
[Variables]
...
[Materials]
  [./porous]
    ...
    graphite_type = NBG-18 # two types considered: IG-110 or NBG-18

    ### input parameters for NBG-18 at 650.2 degree Celsus

    initial_porosity = 0.1782
    initial_bulk_density = 1799
    diffusivity_scaling_factor = 2.19697
    reactive_surface_area = 2.5e3
    rate_scaling_factor = 0.0072 # tweak it
    power_exponent = 1.0

    ### default temperature

    system_temperature = 923.35 # 650.2 degree Celsus
...
################################################################################
[Outputs]
  file_base = out-NBG-18_650C_1_RZ
  interval = 1
  exodus = true
  csv = true
  [./Console]
